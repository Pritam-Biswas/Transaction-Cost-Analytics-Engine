...
'''
This is a class acting as a server for sending the Future Data.
...
'''
class CDataFutureServer(CDataAbstractServer):
    
    '''
    Default constructor of CDataFutureServer class
    Member Variables:
    ...
    Default port for listen: 54000. In order to change the port, change below.
    '''
    def GetDataFromFile(self):
        self.Listen(54000)
        self.ReceiveParams()
        self.m_strFilename = self.m_hashParams['FutureDataFile']
...
'''
This function creates an object of CDataFutureServer class and starts the server.
'''
def main():
    data_future_server_obj = CDataFutureServer()
    data_future_server_obj.GetDataFromFile()
