...
'''
This is a class acting as a server for sending the Cash Data.
...
'''
class CDataCashServer(CDataAbstractServer):
    
    '''
    Default constructor of CDataCashServer class
    Member Variables:
    ...
    Default port for listen: 53000. In order to change the port, change below.
    '''
    def GetDataFromFile(self):
        self.Listen(53000)
        self.ReceiveParams()
        self.m_strFilename = self.m_hashParams['CashDataFile']
...
'''
This function creates an object of CDataCashServer class and starts the server.
'''
def main():
    data_cash_server_obj = CDataCashServer()
    data_cash_server_obj.GetDataFromFile()
